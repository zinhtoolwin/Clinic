...
{
    public partial class nal : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MariitalStatus = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrugSellDrugs", x => new { x.DrugId, x.DrugsellId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodSugar = table.Column<double>(nullable: false),
                    BloodPressureUNo = table.Column<double>(nullable: false),
                    BloodPressureLNo = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatementDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
